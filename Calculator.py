...
verifica = ''
contas = ""
obj_Dis = Display.Dis(comando, contas) # Cria um objeto da classe Dis (faz a destribuição adequada para todas as contas)
resposta = obj_Dis.getSolucao() # Retorna a resposta

# Mais exemplos: #Cria um objeto da classe Display que recebe uma função em formato str conforme o exp: "rad(Dev(div((funcao_dividendo),(funcao_quociente))))"
